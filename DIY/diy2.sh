...
##配置IP
sed -i 's/192.168.8.1/192.168.10.1/g' package/base-files/files/bin/config_generate
...
sed -i "s/DISTRIB_REVISION='*.*'/DISTRIB_REVISION=' By cniori'/g" package/base-files/files/etc/openwrt_release
